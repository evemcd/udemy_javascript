...
if(day === "Monday") {
    ...
    console.log("Prepare theory videos");
} else if(day === "Wednesyday" || day === "Thursday") {
    console.log("Write code examples");
} else if(day === "Friday") {
    console.log("Record videos");
...
1986
true && false && !false
statement is a bigger piece of code that is executed and doesn't produce a value. ends in ;
if-else statement
switch statement
*/
...
//if statement cannot be used like that
