...
console.log(`${myCountry.country} has ${myCountry.population} million ${myCountry.language}-speaking people, ${myCountry.neighbours.length} neughbouring countries and a capital called ${myCountry.capital}.`);